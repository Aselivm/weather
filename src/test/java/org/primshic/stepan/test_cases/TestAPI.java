...
class TestAPI {
    ...
    void locationList(){
        ...
        try {
            locationCoordinatesDTOList1 = objectMapper.readValue(answer, new TypeReference<>() {});
        } catch (JsonProcessingException e) {
            throw new RuntimeException(e);
        }

        assertThat(locationCoordinatesDTOList1).hasSize(5);
        Mockito.when(weatherAPIService.getLocationListByName(LONDON)).thenReturn(locationCoordinatesDTOList1);
